...
3.	Para el departamento de logística:
    ...
    B.	A partir del ingreso de la cantidad de kilómetros que tiene que recorrer estos camiones
      para llegar al destino de la obra, necesitamos que el programa informe cual es el tiempo (en horas)
        que tardará cada uno de los camiones, si sabemos que cada camión puede ir a una velocidad máxima y constante de 90
          km/h  
...
class App(customtkinter.CTk):
    ...
    def btn_cantidad_camiones_on_click(self):
        ...
        alert("UTN", "cantidad de camiones necesarios: " + str(camiones))
    ...
    def btn_tiempo_llegada_on_click(self):
        ...
        kilometros_horas = kilometros /90

        alert("UTN", "cantidad de horas de viaje : " + str(kilometros_horas))
